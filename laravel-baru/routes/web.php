...
Route::view('/view_route', 'view_route', ['name' => 'Putra Maajid']);
...
Route::get('/route-list', function () {
    $routeList = shell_exec('php artisan route:list');
    return view('route-list', compact('routeList'));
})->name('route.list');


Route::get('/routes-cache', function () {
    $routeList = shell_exec('php artisan route:cache');
    return view('routes-cache', compact('routeCache'));
})->name('route.cache');

Route::get('/routes-clear', function () {
    $routeList = shell_exec('php artisan route:clear');
    return view('routes-clear', compact('routeClear'));
})->name('route.clear');

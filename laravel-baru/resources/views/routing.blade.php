        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <div class="list-group list-group-numbered mt-4">
                ...
                <h6 class="">View Route list </h6>
                    <a href="{{ route('route.list') }}" class="route-list list-group-item list-group-item-action">
                ...
                <div class="list-group mt-4">
                    <h6 class="">Route Caching</h6>
                        <a href="{{ route('route.cache') }}" class="route-cache list-group-item list-group-item-action">
                            php artisan route:Cache
                        </a>
                        <a href="{{ route('route.clear') }}" class="route-clear list-group-item list-group-item-action">
